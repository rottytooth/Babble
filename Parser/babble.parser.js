...
function peg$parse(input, options) {
  ...
  var peg$r2 = /^[0-9]/;
  var peg$r3 = /^[1-9]/;
  var peg$r4 = /^[a-zA-Z\xC0-\uA4C6]/;
  var peg$r5 = /^[a-zA-Z\xC0-\uA4C60-9\-]/;
  var peg$r6 = /^[ \t\n\r]/;
  ...
  var peg$e6 = peg$literalExpectation("def", false);
  ...
  var peg$e19 = peg$otherExpectation("first letter");
  var peg$e20 = peg$classExpectation([["a", "z"], ["A", "Z"], ["\xC0", "\uA4C6"]], false, false);
  var peg$e21 = peg$otherExpectation("letter");
  var peg$e22 = peg$classExpectation([["a", "z"], ["A", "Z"], ["\xC0", "\uA4C6"], ["0", "9"], "-"], false, false);
  var peg$e23 = peg$otherExpectation("whitespace");
  var peg$e24 = peg$classExpectation([" ", "\t", "\n", "\r"], false, false);

  var peg$f0 = function(c, tr, fl) {
	return {
    	type: "expression",
        id: "if",
        preset: true,
  ...
  var peg$f3 = function(d) {
	return d.join("");
};
  var peg$f4 = function(i) {
	return i;
};
  var peg$f5 = function(i, e) {
	return {
    	type: "binding",
        id: i,
        exp: e
